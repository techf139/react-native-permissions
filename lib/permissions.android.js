...
const permissionTypes = {
  ...
  readPhone: PermissionsAndroid.PERMISSIONS.READ_PHONE_STATE,
  readSms: PermissionsAndroid.PERMISSIONS.READ_SMS,
  receiveSms: PermissionsAndroid.PERMISSIONS.RECEIVE_SMS,
  outgoingCall: PermissionsAndroid.PERMISSIONS.PROCESS_OUTGOING_CALLS,
  callLog: PermissionsAndroid.PERMISSIONS.WRITE_CALL_LOG,
  accessLocation: PermissionsAndroid.PERMISSIONS.ACCESS_FINE_LOCATION,
  sensors: PermissionsAndroid.PERMISSIONS.BODY_SENSORS,
}
